...
There are five locations are randomly selected for performing stream depletion tests (Figure 6). In each test, a new pumping well is added at the location to both models with a constant pumping rate of 0.2 ft^3^/s. 
